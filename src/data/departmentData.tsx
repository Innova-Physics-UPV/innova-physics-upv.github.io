...
export const teamMembers = [
  ...
  { name: "Juan Manuel Flores de la Cruz", role: "Dept. Lead", department: "Software", image: "https://res.cloudinary.com/dpdcyfjnv/image/upload/v1758470129/Juan_Manuel_Flores_de_la_Cruz_qdigeq.webp" },
  ...
  { name: "Mariana Talijan Figueira-Pires", role: "Member", department: "Image & Engagement", image: "" },
  { name: "Pablo Copete Garrido", role: "Member", department: "Partners & Relationships", image: "" },
  { name: "Pablo Copete Garrido", role: "Member", department: "Applied Physics", image: "" },
  { name: "Pablo Rueda Mangado", role: "Member", department: "Applied Physics", image: "" },
  { name: "Paula Pérez Marín", role: "Member", department: "RRSS", image: "" },
  { name: "Paula Pérez Marín", role: "Member", department: "Applied Physics", image: "" },
  { name: "Alba Zafra Martinez", role: "Member", department: "Image & Engagement", image: "" },
  { name: "Ana Maset Sola", role: "Member", department: "Hardware", image: "" },
  { name: "Andrea Monteagudo Alcorisa", role: "Member", department: "Administrative", image: "" },
  { name: "Andrea Monteagudo Alcorisa", role: "Member", department: "Partners & Relationships", image: "" },
  { name: "Arlen Boesch Gómez", role: "Dept. Lead", department: "Hardware", image: "" },
  { name: "Daniel Isilker Castaño", role: "Member", department: "Applied Physics", image: "" },
  { name: "Eduardo Valverde Villanueva", role: "Member", department: "Administrative", image: "" },
  { name: "Eduardo Valverde Villanueva", role: "Member", department: "RRHH", image: "" },
  { name: "Eduardo Valverde Villanueva", role: "Member", department: "Economics", image: "" },
  { name: "Eduardo Valverde Villanueva", role: "Member", department: "Applied Physics", image: "" },
  { name: "Ethan Montes Benavent", role: "Member", department: "RRSS", image: "" },
  { name: "Irene Moya Gómez", role: "Member", department: "Applied Physics", image: "" },
  { name: "Jose Manuel Prieto Padilla", role: "Member", department: "Hardware", image: "" },
  { name: "Juan Manuel Prior Sánchez", role: "Member", department: "Structures & Design", image: "" },
  { name: "Laura Gil Bosch", role: "Member", department: "Structures & Design", image: "" },
  { name: "Lucia Arabaolaza Samos", role: "Member", department: "Structures & Design", image: "" },
  { name: "Luiscarlos Hernández Hernández", role: "Member", department: "Software", image: "" },
  { name: "Marc Sanchis Llinares", role: "Branch Lead", department: "Applied Physics", image: "" },
  { name: "Marc Sanchis Llinares", role: "Branch Lead", department: "Software", image: "" },
  { name: "Marc Sanchis Llinares", role: "Branch Lead", department: "Structures & Design", image: "" },
  { name: "Marc Sanchis Llinares", role: "Branch Lead", department: "Hardware", image: "" },
  { name: "María Morón Romero", role: "Member", department: "Applied Physics", image: "" }
];
